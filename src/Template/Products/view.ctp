    ...
    <div class="col-md-2" id="actions-sidebar">
        <div class="box box-primary">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li><?= $this->Html->link(__('Edit {0}', [__('Product')]), ['action' => 'edit', $product->id]) ?> </li>
            ...
            <div class="box-body">
                ...
                <div class="related">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            <td><?= h($product->stock->id) ?></td>
                            <td><?= h($product->stock->product_id) ?></td>
                            <td><?= h($product->stock->quantity) ?></td>
                            <td><?= h($product->stock->unit_price) ?></td>
                            <td><?= h($product->stock->unit_cost) ?></td>
                        </tr>
